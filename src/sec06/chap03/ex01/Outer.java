...
public class Outer {
    ...
    //  💡2. 정적(클래스) 내부 클래스
    //  ⭐  내부 클래스에서도 접근자 사용 가능. private 으로 바꿔볼 것
    public static class InnerSttcMember{
        //  ⭐ 외부 클래스의 클래스 필드만 접근 가능, 정적만 sttc
    ...
    public void memberFunc(){
        ...
        class MethodMember{
            ...
            InnerInsMember innerInsMember = new InnerInsMember();
    ...
    public void innerFuncs(){
        new InnerInsMember().func();
        new InnerSttcMember().func();
    }

    public InnerInsMember getInnerInsMember(){
        return new InnerInsMember();
    }
}
