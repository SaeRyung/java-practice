...
//        System.out.println("불리언을 입력해 주세요.");
//
//        //  💡 다음 입력값이 특정 자료형으로 읽힐 수 있는지 확인
//        while(sc.hasNextBoolean()){ //boolean값 들어가는지 확인클래스
//            //  💡 대소문자 무관 비교
...
//        sc.close();
        ...
        while (sc.hasNext()){
            String nexWord = sc.next();
            if(nexWord.equalsIgnoreCase("quit")) break;
            System.out.println("입력값: " + nexWord);
        }
